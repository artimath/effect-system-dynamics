 ...
 * ```
 */
export class Stock extends Schema.Class("Stock")({
    id: StockId,
 ...
 * ```
 */
export class Flow extends Schema.Class("Flow")({
    id: FlowId,
    name: Schema.NonEmptyTrimmedString,
 ...
 * ```
 */
export class Variable extends Schema.Class("Variable")({
    id: VariableId,
    name: Schema.NonEmptyTrimmedString,
 ...
 * ```
 */
export class TimeConfig extends Schema.Class("TimeConfig")({
